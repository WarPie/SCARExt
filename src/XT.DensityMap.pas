...
function DensityMapNormed(const TPA:TPointArray; Radius, Passes, Beta:Integer): T2DIntArray; StdCall;
procedure TPADensitySort(var Arr: TPointArray; Radius, Passes:Integer); StdCall;
